...
class Pipes:
    ...
    def __init__(self, win_width):
        ...
        self.top_height = Ground.ground_lvl - self.bottom_height - self.opening
        self.bottom_rect, self.top_rect = pygame.Rect(0,0,0,0), pygame.Rect(0,0,0,0)
        self.passed = False
        self.off_screen = False

    def draw(self, window):
        self.bottom_rect = pygame.Rect(self.x, Ground.ground_lvl - self.bottom_height, self.width, self.bottom_height)
